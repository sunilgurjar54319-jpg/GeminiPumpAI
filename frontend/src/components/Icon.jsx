function Icon({
  ...
  const icons = {
    ...
    settings: (
      <>
        <path d="M9.6 3.2h4.8l.8 2.3a7.1 7.1 0 0 1 1.6.9l2.3-.7 2.4 4.1-1.8 1.6a7.2 7.2 0 0 1 0 1.9l1.8 1.6-2.4 4.1-2.3-.7a7.1 7.1 0 0 1-1.6.9l-.8 2.3H9.6l-.8-2.3a7.1 7.1 0 0 1-1.6-.9l-2.3.7-2.4-4.1 1.8-1.6a7.2 7.2 0 0 1 0-1.9L2.5 9.8l2.4-4.1 2.3.7a7.1 7.1 0 0 1 1.6-.9l.8-2.3Z" />
    ...
    fingerprint: (
      <>
        ...
        <path d="M8 17v-4a4 4 0 0 1 8 0v4" />
        <path d="M5 17v-4a7 7 0 0 1 14 0v4" />
        <path d="M3 17v-4a9 9 0 0 1 18 0v4" />
        <path d="M8 21c-1.5-1-2.5-2.8-2.5-4.5" />
        <path d="M16 21c1.5-1 2.5-2.8 2.5-4.5" />
        <path d="M12 21v-5" />
      </>
    ),
